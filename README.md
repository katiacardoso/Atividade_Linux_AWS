...
- No terminal do Putty, execute os comandos:
  
- passando para o putty, executa abaixo para instalação do pacotes das ferramentas do EFS:
...
- Em seguida, montou-se um sistema de arquivos EFS com aquele **Nome de DNS** copiado, com o comando abaixo:
  ...
  Uma descrição geral dos comandos existentes nesta linha de comando acima comando é:
    ...
    - *efs fs-0ef31a5a2cd4d79b2.efs.us-east-1.amazonaws.com* → é um endereço de DNS copiado da página de detalhes do EFS. Importante lembrar que cada instância tem um endereço diferente, então copie o endereço referente a sua instância
